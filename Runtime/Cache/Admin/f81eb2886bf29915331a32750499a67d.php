...
<div class="row">
	<div class="col-xs-12">	
		<form class="form-horizontal" id="validation-form"  method="post" action='<?php echo ($action); ?>'>
			...
			<?php if(!empty($_GET['id'])): ?><input name="code_id" type="hidden" value="<?php echo ($_GET['id']); ?>" /><?php endif; ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-11">
					<div class="clearfix">
					<input name="code" id="value" class="col-xs-10 col-sm-5" value="<?php echo ((isset($d["code"]) && ($d["code"] !== ""))?($d["code"]):''); ?>" type="text">
					</div>
				</div>
			</div>
...
<script type="text/javascript">
            ...
            $(function() {
                ...
                $("#checkNewsTitle").click(function() {
                    ...
                    $.getJSON("/theguide/admin.php?s=/Code/checkNewsTitle", {title: $("#title").val(), id: "<?php echo ($info["id"]); ?>"}, function(json) {
